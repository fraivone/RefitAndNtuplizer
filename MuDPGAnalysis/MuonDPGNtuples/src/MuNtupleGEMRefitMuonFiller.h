#ifndef MuNtuple_MuNtupleGEMRefitMuonFiller_h
#define MuNtuple_MuNtupleGEMRefitMuonFiller_h
...
class MuNtupleGEMRefitMuonFiller : public MuNtupleBaseFiller
{

 public:

  /// Constructor
  MuNtupleGEMRefitMuonFiller(edm::ConsumesCollector && collector,
  ...
  ///Destructor
  virtual ~MuNtupleGEMRefitMuonFiller();
